...
```{r}
monthly_admissions <- read_xlsx("data/bfi-yearbook-2022-uk-box-office-2021.xlsx", sheet = "T2", range = cell_rows(2:15)) %>%
  mutate(
...
monthly_admissions_5yr <- read_xlsx("data/bfi-yearbook-2022-uk-box-office-2021.xlsx", sheet = "F2", range = cell_rows(2:14)) %>%
  rename("2021" = 6) %>%
  rename("Month" = 1) %>% 
  mutate(
    `2020` = as.numeric(`2020`),
...
#| fig-cap: "Monthly UK cinema admissions, 2017-2021. Dashed line is 5-year average. Source: CAA. [Download this data.](/chapters/box-office/data/bfi-yearbook-2022-uk-box-office-2021.xlsx)"
#| column: page
